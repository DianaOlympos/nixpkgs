...
rec {
  ...
  interpreters = rec {
    ...
    # R23
    erlangR23_bootstrapped =
      lib.callErlangBootstrapped ../development/interpreters/erlang/R23.nix {
        parallelBuild = true;
      };
    erlangR23 = lib.callErlang ../development/interpreters/erlang/R23.nix {
      ...
      parallelBuild = true;
      bootstrapped_erlang = erlangR23_bootstrapped;
    };
    ...
    # R22
    erlangR22_bootstrapped =
      lib.callErlangBootstrapped ../development/interpreters/erlang/R22.nix {
        parallelBuild = true;
      };
    ...
    erlangR22 = lib.callErlang ../development/interpreters/erlang/R22.nix {
      ...
      # Can be enabled since the bug has been fixed in https://github.com/erlang/otp/pull/2508
      parallelBuild = true;
      bootstrapped_erlang = erlangR22_bootstrapped;
    };
    ...
    # R21
    erlangR21_bootstrapped =
      lib.callErlangBootstrapped ../development/interpreters/erlang/R21.nix {
      };
    erlangR21 = lib.callErlang ../development/interpreters/erlang/R21.nix {
      wxGTK = wxGTK30;
      bootstrapped_erlang = erlangR21_bootstrapped;
    };
    ...
    # R20
    erlangR20_bootstrapped =
      lib.callErlangBootstrapped ../development/interpreters/erlang/R20.nix {
      };
    erlangR20 = lib.callErlang ../development/interpreters/erlang/R20.nix {
      wxGTK = wxGTK30;
      bootstrapped_erlang = erlangR20_bootstrapped;
    };
    ...
    # R19
    erlangR19_bootstrapped =
      lib.callErlangBootstrapped ../development/interpreters/erlang/R19.nix {
      };
    erlangR19 = lib.callErlang ../development/interpreters/erlang/R19.nix {
      wxGTK = wxGTK30;
      openssl = openssl_1_0_2;
      bootstrapped_erlang = erlangR19_bootstrapped;
    };
    ...
    # R18
    erlangR18_bootstrapped =
      lib.callErlangBootstrapped ../development/interpreters/erlang/R18.nix {
      };
    erlangR18 = lib.callErlang ../development/interpreters/erlang/R18.nix {
      wxGTK = wxGTK30;
      openssl = openssl_1_0_2;
      bootstrapped_erlang = erlangR18_bootstrapped;
    };
